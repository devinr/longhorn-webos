...
//windowBorderDel is a temp. fix, a number that is withdrawn from window heights, we will later replace
//with a function to calculate bottom window border+taskbar height to get the right window height
var windowBorderDel = 100;
