...
kernel_sidebar.prototype.addWidget = function(type,position,width,height,bottom,right) {
	...
	if (type == 'clock') {
		...
		tmp.innerHTML							= '<img onclick="sidebarCalendar.cycle();" id="sidebarClock" border="0" src="images/sidebar/clockbg.png" style="position: absolute; z-index: 3; bottom: 0px; right: 0px;">'+
